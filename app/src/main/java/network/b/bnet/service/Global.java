...
class Global {
    ...
    public static MatchedNodeInfo RNode_getLanMatchNodeInfo(long destIpLong)
    {
        ...
        //LogUtils.d("debug",Global.MatchedPeerNode.get(strDestNet));//查询
    ...
    {
        String strDestIp = "0";
        //LogUtils.d("debug","RNode_getWanOrOverMatchNodeInfo:"+Global.MatchedPeerNode.get(strDestIp));//查询
    ...
    {
        String strDestIp = "0";
        //LogUtils.d("debug","RNode_getOverWallRouteInfo:"+Global.routeInfo.get(strDestIp));//查询
    ...
    public static RouteItem RNode_getLanRouteInfo(long destIpLong)
    {
        long u4DestNet  = destIpLong & 0xFFFFFF00;
        String strDestNet = String.valueOf(u4DestNet);
        //LogUtils.d("debug","RNode_getLanRouteInfo:"+Global.routeInfo.get(strDestNet));//查询
